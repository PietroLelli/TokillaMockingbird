...
public class EndGameViewImpl implements View {
	...
	private Rectangle rRestartButton, rLblBackground, rExitButton;
	...
	class EndGamePanel extends JLayeredPane {
		...
		public EndGamePanel() {
			...
			final ImageIcon background = new ImageIcon(new ImageIcon(this.getClass().getResource("/GameOver.png")).getImage().getScaledInstance(MENU_WIDTH, MENU_HEIGHT, Image.SCALE_SMOOTH));
			lblBackground = new JLabel(background);
			lblBackground.setBounds(rLblBackground);
			add(lblBackground, DEFAULT_LAYER);
			
			final ImageIcon restartImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/RestartButton.png")).getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
			final ImageIcon exitImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/ExitButton2.png")).getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
