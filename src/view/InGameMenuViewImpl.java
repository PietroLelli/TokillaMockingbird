...
public class InGameMenuViewImpl implements View {
	...
	private JButton resumeButton, controlsButton, exitButton;
	private Rectangle rResumeButton, rControlsButton, rLblBackground, rExitButton;
	...
	class InGameMenuPanel extends JLayeredPane {
		...
		public InGameMenuPanel() {
			...
			final ImageIcon background = new ImageIcon(new ImageIcon(this.getClass().getResource("/InGameMenu.png")).getImage().getScaledInstance(MENU_WIDTH, MENU_HEIGHT, Image.SCALE_SMOOTH));
			lblBackground = new JLabel(background);
			lblBackground.setBounds(rLblBackground);
			add(lblBackground, DEFAULT_LAYER);
			
			final ImageIcon resumeImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/resumeButton.png")).getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
			final ImageIcon controlsImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/controlsButton2.png")).getImage().getScaledInstance(IMAGE_WIDTH, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
			final ImageIcon exitImage = new ImageIcon(new ImageIcon(this.getClass().getResource("/exitButton.png")).getImage().getScaledInstance(IMAGE_HEIGHT, IMAGE_HEIGHT, Image.SCALE_SMOOTH));
